...
export default Modal.extend({
    ...
    initialize(options = {}) {
        ...
        if (options.isNew) {   // new mode
            ...
            const maxIndexSizeObject = this.isArchiverAppInstalled ?
        ...
        */
        ...
        if (this.model.controller.get('singleInstance') && !this.isArchiverAppInstalled) {
    ...
    onSubmit() {
        ...
        this.modelToUpdate = this.isArchiverAppInstalled ? this.addEditIndexModel : this.model.entity;

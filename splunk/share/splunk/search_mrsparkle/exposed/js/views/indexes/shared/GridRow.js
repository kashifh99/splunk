...
function (
    ...
    return BaseView.extend({
        ...
        isRemoteIndex: function() {
                ...
                if (this.model.entity.entry.content.get('remotePath')) {
                    setTimeout(function() {
                        $('.new-entity-button')
                            .addClass('disabled')
        ...
        render: function () {
            ...
            var html = _(this.template).template({
                ...
                archiveMgmtLink: route.dynamic_data_archive_manager(this.model.application.get('root'), this.model.application.get('locale'), this.model.application.get('app'))
            });
        ...
        columns: [
            {
                ...
                visible: function() {
                    return this.model.controller.get('mode') === 'local' || this.model.controller.get('singleInstance');
                }
            }, {
                id: 'totalRawSizeMB',
                title: _('Current Size').t(),
                ...
                visible: function() {
                    return this.model.controller.get('mode') === 'cloud' && !this.model.controller.get('singleInstance');
                }
            }, {

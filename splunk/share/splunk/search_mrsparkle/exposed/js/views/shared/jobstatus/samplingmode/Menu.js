        ...
        return SyntheticSelectControl.extend({
            ...
            render: function() {
                ...
                if (isRealTime) {
                    ...
                    this.$el.find('a.dropdown-toggle').attr("aria-describedby", "sampling_tpl");
                    this.tooltip('destroy');
                    this.tooltip({
                        animation: false, 
                        ...
                        container: 'body',
                        placement: 'right',
                        template: '<div id="sampling_tpl" role="tooltip"><div class="arrow"></div><div class="tooltip-inner"></div></div>'
                    });
                }
            },

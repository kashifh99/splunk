    ...
    function(
        ...
        return BaseRouter.extend({
            ...
            page: function(locale, app, page) {
                ...
                this.workloadManagementStatus.bootstrapWorkloadManagementStatus(this.deferreds.workloadManagementStatus);
                ...
                $.when(appsFetch).done(_(function() {
                    ...
                    $.when(usersFetch, appLocalFetch, userFetch, vixFetch, archiveFetch, this.deferreds.pageViewRendered, this.deferreds.workloadManagementStatus).done(_(function() {

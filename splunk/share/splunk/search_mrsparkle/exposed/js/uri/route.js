    ...
    function($, _, splunkutil, splunkdUtils, splunkConfig, URI_CONSTANTS, console)
{
    ...
    exports.analysis_workspace = function(root, locale, app, options) {
        ...
        return exports.page(root, locale, app, URI_CONSTANTS.PAGES.ANALYSIS_WORKSPACE, options);
    };
    ...
    exports.getViewRouteData = function(view, appsCollection) {
        var analysisWorkspaceAppModel = appsCollection ? appsCollection.findByEntryName('splunk_metrics_workspace') : undefined;
        var analysisWorkspaceEnabled = analysisWorkspaceAppModel && !analysisWorkspaceAppModel.isDisabled();
        if (view === 'analysis_workspace' && analysisWorkspaceEnabled) {

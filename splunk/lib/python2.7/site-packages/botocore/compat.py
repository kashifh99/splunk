...
# botocore's MD5 detection is junk; instead of using OpenSSL's MD5 which may
# or may not be available because of FIPS mode, use `_md5` which will always
# be available on Splunk's python
MD5_AVAILABLE = True
...
def get_md5(*args, **kwargs):
    ...
    if sys.version_info.major < 3:
        return _md5.new(*args, **kwargs)
    else:
        return _md5.md5(*args, **kwargs)

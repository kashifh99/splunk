...
def init(storage_type='ram', path=None, path_header=None, name='session_id',
         timeout=60, domain=None, secure=False, restart_persist=True, httponly=False, clean_freq=5, **kwargs):
    ...
    restart_persist: If true then the session cookie will persist across
        browser restarts
    ...
    if not restart_persist:
        timeout = 0
    set_response_cookie(path=path, path_header=path_header, name=name,
                        timeout=timeout, domain=domain, secure=secure, httponly=httponly)

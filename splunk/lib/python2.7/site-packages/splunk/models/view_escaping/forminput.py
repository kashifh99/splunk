from base import *
from drilldown import parseEventHandler
from tokendeps import parseTokenDeps
import splunk.util
import logging
import inspect
...
import StringIO
import csv
from search import Search, createSearchFromSearchXml
    ...
    def fromXml(self, lxmlNode, sourceApp):
        ...
        for k in ['defaultValue', 'initialValue']:
            ...
            if value is not None:
                reader = csv.reader(StringIO.StringIO(value.strip()), delimiter=',')

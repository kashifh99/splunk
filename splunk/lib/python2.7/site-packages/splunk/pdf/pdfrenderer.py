...
import pdfgen_base as pb
import pdfgen_table as pt

from font_manager import FontManager
import image_utils as imageUtils
from html_image import HtmlImage
from pdf_html_parser import PdfHtmlParser
...
class PDFRenderer(object):
    ...
    def renderHtmlWithImage(self, text):
        ...
        for frag in fragments:
            if frag.tag != 'img':
                self.renderHtmlWithoutImage(etree.tostring(frag, encoding='UTF-8'))
            else:
        ...
        if positions:
            for position in positions:
                ...
                if position in [SETTING_HEADER_LEFT, SETTING_HEADER_RIGHT]:
                    ...
                    headerWidth = (doc.width - elementWidth) / 2
                ...
                if position in [SETTING_FOOTER_LEFT, SETTING_FOOTER_RIGHT]:
                    ...
                    footerWidth = (doc.width - elementWidth) / 2
...
class PageElement(object):
    ...
    def getPositionInPage(self):
        ...
        if self._pos in [SETTING_FOOTER_LEFT, SETTING_HEADER_LEFT]:
            ...
            x = inch + self._doc.width / 2 - self.getElementWidth() / 2

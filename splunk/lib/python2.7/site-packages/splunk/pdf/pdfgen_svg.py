...
class SVGRenderer(object):
    ...
    def __init__(self, svgString, fontManager):
        ...
        self._attributeMapPolygon    = dict(self._attributeMapPolygon.items() + self._attributeMapSolidShape.items())
        self._attributeMapPolyline   = dict(self._attributeMapPolyline.items() + self._attributeMapSolidShape.items())
        self._attributeMapLine       = dict(self._attributeMapLine.items() + self._attributeMapSolidShape.items())
    ...
    def renderElementSvg(self, element, group, isClipPath=0):
        ...
        if viewBoxString != None:
            ...
            self._viewBox = map(lambda x: float(x), viewBoxStringArray)
    ...
    def _opacityMapping(self, attributes, svgAttributes):
        ...
        for opacityOverrideKey in self._opacityOverrideMap.keys():

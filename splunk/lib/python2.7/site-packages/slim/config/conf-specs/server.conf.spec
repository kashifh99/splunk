...
* Determines maximum time, in seconds, that a peer node waits for search
  ...
  in reponse to the 'splunk offline' (or) 'splunk offline --enforce-counts' command.
...
* the max number of buckets that can be downloaded at the same time from external storage
* Defaults to 8

max_concurrent_uploads = <unsigned integer>
* the max number of buckets that can be uploaded at the same time to external storage
* Defaults to 8

max_open_buckets = <unsigned integer>
* the max number of buckets that can be open at any given time
* Defaults to 100000
...
* eviction of buckets with latest time more recent than this will be deferred
* Defaults to 86400 (24 hours)

hotlist_bloom_filter_recency_hours = <unsigned integer>
* eviction of non journal or tsidx part of buckets with latest time more recent than this will be deferred
